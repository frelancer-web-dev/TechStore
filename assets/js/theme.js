...
(function() {
  ...
  document.addEventListener('visibilitychange', () => {
    if (document.hidden) {
      ...
      console.log('Theme: Page hidden');
    } else {
      // Page is visible again
      console.log('Theme: Page visible');
    }
  });
  ...
  if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
    console.log('%c🎨 Theme Manager Loaded', 'color: #FF6B35; font-size: 14px; font-weight: bold;');
    console.log('Use ThemeManager.toggle() to switch themes');
    console.log('Use ThemeManager.getCurrentTheme() to check current theme');
    console.log('Keyboard shortcut: Ctrl/Cmd + K');
  }
