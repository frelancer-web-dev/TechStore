...
(function() {
  ...
  async function loadTranslation(lang) {
    try {
      ...
      const path = isRootPage ? './data/translations/' : '../../data/translations/';
  ...
  async function changeLanguage(lang) {
    ...
    console.log(`Changing language to: ${mappedLang}`);
    ...
    console.log(`✓ Language changed to: ${mappedLang}`);
  }
  ...
  function updateLanguageButton() {
    ...
    if (langSpan && translations.language) {
      langSpan.textContent = translations.language;
    }
  }
